			    			...
			    			<div class="col-xs-12 no-padding-lr">
								<div class="topbar">
									<div class="col-xs-4 pull-right">
						    				<a href="<%=request.getContextPath()%>/show-add-member" class="btn btn-default" style=""> Thêm thành viên</a>
						    			</div>
								...
								<td>
									<center>
											<div class="pull-right" >
												<a href="<%=request.getContextPath()%>/show-edit-member" class="btn btn-default" style=""> Sửa </a>
											</div>
										</center>
								</td>
								<td>
