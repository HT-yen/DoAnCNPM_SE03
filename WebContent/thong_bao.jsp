		...
		<div class="new-item-brbt">
			<div class="col-xs-12 col-sm-5 no-padding-l home-blog-content-left">
				<div class="new-img">
						...
						<a href="ebook-nhung-em-be-khon-ngoan-day-con-tu-bao-ve-minh.html" title=""><img src="<%=request.getContextPath()%>/templates/public/images/thongbao.jpg" alt="Ebook: Những em bé khôn ngoan - dạy con tự bảo vệ mình"></a>
		...
		<div class="new-item-brbt">
			<div class="col-xs-12 col-sm-5 no-padding-l home-blog-content-left">
				<div class="new-img">
						...
						<a href="ebook-nhung-em-be-khon-ngoan-day-con-tu-bao-ve-minh.html" title="Ebook: Những em bé khôn ngoan - dạy con tự bảo vệ mình"><img src="<%=request.getContextPath()%>/templates/public/images/thongbao.jpg" alt="Ebook: Những em bé khôn ngoan - dạy con tự bảo vệ mình"></a>
				...
				<div class="row">					
					<section class="section-blog">
						<div class="col-xs-12" style="margin-bottom:15px">
							<h1 class="default_title"><a href="#">Thông báo</a></h1>
						</div>
								...
								<div class="new-item-brbt">
									...
									<div class="col-xs-12 col-sm-7 no-padding-r home-blog-content-right">
										<div class="home-blog-content-right-div">
											...
											<a class="theme_default_btn" href="">Xem chi tiết <img src="assets/theme_default_btn_bg-min8b77.png?1492665207586"></a>
										</div>
									</div>
								</div>	
